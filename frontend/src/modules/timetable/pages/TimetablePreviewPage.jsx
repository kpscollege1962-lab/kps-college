...
export default function TimetablePreviewPage() {
  ...
  // ── Print customization: title + watermark (local uploads) ──────────────────
  // Temporary fallback while the Campus Settings-based branding feature is
  // paused — persisted in localStorage so they survive a page refresh.
