import { LayoutDashboard, Users, CalendarDays, Layers, Settings, UserCog, ClipboardList, Wallet } from 'lucide-react'
...
const campusAdminNav = [
  ...
  { id: 'fees',      title: 'Fees',      icon: Wallet,          path: '/portal/fees' },
